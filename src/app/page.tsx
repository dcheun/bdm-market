...
const perks = [
  {
    name: 'Instant Deliver',
    Icon: ArrowDownToLine,
    description:
      'Get your assets delivered to your email in seconds and download them ' +
      'right away.',
  },
  {
    ...
    description:
      ...
      'highest quality standards. Not happy? We offer a 30-day refund ' +
      'quarantee.',
  },
  {
    name: 'For the Planet',
                ...
                <div className="md:flex-shrink-0 flex justify-center">
                  <div
                    className={
                      ...
                      'rounded-full bg-blue-100 text-blue-900'
                    }
                  >
